...
<div class="container-scroller">
    ...
    <div class="w-full p-12">
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="{{url('/food/update', $food->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-3 sm:col-span-2">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <span
                                        class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">Price ($):</span>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="3"
                                          ...
                                          placeholder="Food description">{{$food->description}}</textarea>
                            </div>
                            <p class="mt-2 text-sm text-gray-500">
                                Brief description for your food
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                <span class="inline-block h-24 w-24 rounded-full overflow-hidden bg-gray-100">
                                    <img src="/food-images/{{$food->image}}" alt="{{$food->image}}"/>
                                </span>
                                <button type="button"
