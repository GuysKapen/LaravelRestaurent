        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contact-form">
                    <form id="contact" action="{{url('/reservation/create')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <fieldset>
                                    <input type="number" name="guest" id="guest" placeholder="2">
                                </fieldset>
                            </div>
                            <div class="col-lg-6">
                                <div id="filterDate2">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <fieldset>
                                    <input type="time" name="time" id="time" placeholder="08:00">
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
